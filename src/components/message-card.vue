<template >
  <view class="scenic-spot-message-text-group">
    ...
    <image
      :src="data.photo?data.photo:'https://hsstatic.sufe.edu.cn/mini-images/touxiang.png'"
    ...
    <view class="scenic-spot-message-text-content">
      <view class="scenic-spot-message-text-label">
        ...
        <view class="scenic-spot-message-text-icon-group" @click="click">
          <image class="thumbsUpImgClass" v-if="imageName!==undefine&&imageName!==null" :src="'https://hsstatic.sufe.edu.cn/mini-images/'+imageName+'.png'" @click="thumbsupClick(data,index)" mode="widthFix"/>
