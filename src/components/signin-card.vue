<template>
  <view class="page-signin">
    <view v-for="(item,index) in data" :key="index" class="signin-card">
      <navigator 
        :url="item.sceneryid?'/pages/map/sight/main?activitySight=true&id='+ item.sceneryid + '&name=' + item.sceneryTitle:'/pages/map/sight/main'"
      >
        ...
        <view class="signin-card-content">
          <view class="signin-card-content-title">
          ...
          <view class="signin-card-content-detail">
            <view>点击查看详情</view>
          </view>
        </view>
        <view class="signin-card-icon">
          <view class="signin-card-icon-inner">
          ...
          <view class="signin-card-icon-text">
            <!-- <view
...
.signin-card .signin-card-content-icongroup {
  width: 50%;
  height: 26px;
  /* margin-top: -29px; */
  z-index: 999;
...
.signin-card-content-title ._text {
  font-size: 30rpx;
  margin-top: 0 !important;
}
.signin-card-content-desc {
  display: flex;
  flex-direction: row;
  padding: 5px;
  font-size: 10px;
}
.signin-card-content-desc-item {
  margin-right: 5px;
}
.signin-card-content-icongroup {
  padding-left: 9px;
  display: flex;
  /* margin-bottom: 10px; */
}
.signin-card-content-icongroup .on-status {
  margin-left: 20px;
  font-size: 14px;
  line-height: 27px;
  color: rgb(223, 64, 64);
}
.signin-card-content-icongroup .sign-up-status {
  margin-left: 20px;
  font-size: 14px;
  line-height: 27px;
  color: rgb(96, 170, 231);
}
.signin-card-content-detail {
  font-size: 24rpx;
  color: #aaa;
  padding-left: 18rpx;
}
...
.signin-card-icon-inner {
  width: 62%;
  margin: auto;
  display: flex;
  justify-content: center;
}
.signin-card-icon-inner ._wux-icon {
  color: #d25136;
}
.signin-card-icon-text {
  text-align: center;
  font-size: 13px;
}
.signin-card span {
...
.signin-card-content-icongroup-text {
  width: 50%;
  font-size: 28rpx;
  color: #aaa;
}
